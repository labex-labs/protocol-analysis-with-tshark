...
<p align="center">
  <a href="https://labex.io/ja/courses/protocol-analysis-with-tshark">
    <img src="https://course-cover.labex.io/protocol-analysis-with-tshark.png?lang=ja" alt="Tshark によるプロトコル解析">
  </a>
</p>

Tshark を活用した高度なプロトコル解析手法を学びます。TCP/UDP ストリームの再構築、特定のプロトコルフィールドの抽出、そして脅威ハンティングやマルウェア検知に向けたトラフィック解析の自動化技術を習得しましょう。

[LabEx でコースを開始](https://labex.io/ja/courses/protocol-analysis-with-tshark)

## 演習

|   インデックス | 名前              | 難易度   | 練習                                                                                                                                              |
|----------|-----------------|-------|-------------------------------------------------------------------------------------------------------------------------------------------------|
|        1 | Tshark 入門       | 初級    | <a target='_blank' href='https://labex.io/ja/labs/linux-introduction-to-tshark-656120?course=protocol-analysis-with-tshark'>ラボを開始</a>           |
|        2 | ネットワークストリームの追跡  | 初級    | <a target='_blank' href='https://labex.io/ja/labs/linux-following-network-streams-656119?course=protocol-analysis-with-tshark'>ラボを開始</a>        |
|        3 | フィールドの抽出とフォーマット | 初級    | <a target='_blank' href='https://labex.io/ja/labs/linux-extracting-fields-and-formatting-656118?course=protocol-analysis-with-tshark'>ラボを開始</a> |
|        4 | 自動化されたトラフィック分析  | 中級    | <a target='_blank' href='https://labex.io/ja/labs/linux-automated-traffic-analysis-656117?course=protocol-analysis-with-tshark'>チャレンジを開始</a>    |
